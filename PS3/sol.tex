...
\begin{homeworkProblem}
\begin{enumerate}
    \item[(a)] See \Cref{fig:comparison}: Comparison of original and compressed images.
    \begin{figure}
        \centering
        \includegraphics[width=0.75\linewidth]{PS3/output/peppers_compressed_comparison.png}
        \caption{Comparison of original and compressed images}
...
if __name__ == '__main__':
    ...
    \item[(b)] The color now can be represented by a 4-bit number (0 to 15) whereas originally it takes three 8-bits number. Therefore the compression factor is approximately 6.
\end{enumerate}
\end{homeworkProblem}
