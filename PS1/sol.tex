...
\begin{homeworkProblem}
    ...
    GDA is much poorer than logistic regression for dataset 1 but performs almost as good as logistic regression for dataset 2.This is because GDA assumes a Gaussian distribution of the features of the 2 classes. So for dataset 1 where it is not Gaussian, GDA fails.
\end{homeworkProblem}
